...
TRAIN_CLASSES               = "yolov4/_classes.txt"
TRAIN_ANNOT_PATH            = "./train/_annotations.txt"
TRAIN_LOGDIR                = "log"
...
# TEST options
TEST_ANNOT_PATH             = "./test/_annotations.txt"
TEST_BATCH_SIZE             = 10
TEST_INPUT_SIZE             = 416
TEST_DATA_AUG               = True
TEST_DECTECTED_IMAGE_PATH   = ""
TEST_SCORE_THRESHOLD        = 0.35
...
number_of_main_ingredients  = 33 # 주재료 개수